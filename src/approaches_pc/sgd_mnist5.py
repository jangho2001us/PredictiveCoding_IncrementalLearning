...
class Appr(object):
    ...
    def train_epoch(self, t, x, y):
        ...
        for i in range(0, len(r), self.sbatch):
            ...
            # Forward with PC
            vhat, Loss, dLdy, v, epsilon = T2PC.PCInferCL(t, self.taskinfo, self.model, self.criterion,
                                                          images, targets,
    ...
    def eval(self, t, x, y):
        ...
        for i in range(0, len(r), self.sbatch):
            ...
            mask = T2PC.get_mask(self.taskinfo, t).cuda()

            targets = T2PC.get_target(self.taskinfo, t, targets).cuda()
