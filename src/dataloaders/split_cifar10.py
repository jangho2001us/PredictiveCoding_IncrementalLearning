...
def get(seed=0, pc_valid=0.10):
    ...
    data_dir = os.path.join('../dat/split_cifar10_seed{}'.format(seed))
    ...
    for s in ['train', 'test']:
        ...
        for image, target in loader:
            ...
            # path = '/home/jangho/data2/split_cifar10/image_{}_label{}.jpg'.format(idx, target.numpy()[0])
